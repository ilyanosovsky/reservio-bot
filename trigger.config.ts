...
//     планирует вечер, но лишь пока settings.planner_enabled в Supabase точно
//     равен 'true': при любом другом значении run() молча выходит. Активация
//     боевого cron одобрена пользователем и включена 04.08.2026
//     (docs/wiki/Runbook.md → «Планировщик»); выключается тем же флагом, а не
//     переделкой конфига.
//   — heartbeat (cron '12 18 * * *' = 22:12 Тбилиси) не бронирует ничего
//     вовсе: он сверяет план вечера с квитанциями drop_reports и будит админов,
