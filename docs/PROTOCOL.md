...
- **Дроп — почасовой, rolling T+7 (подтверждено 30.07.2026, принято как
  истина):** слот на час `H` дня T+7 появляется в `(H-1):58:50–59:00` дня T.
  ...
  Для пары 20:00+21:00 это два дропа: ~19:58:50 и ~20:58:50 дня T.
  Разброс секунд уточняется дальнейшими наблюдениями.
