...
| 06.08 21:00 C3+C2 | НЕ появился за всё окно 21:58:30–22:03:30 (117 опросов) | боевой таск | ❌ см. аномалию ниже |
...
### Аномалия 21:00 (открытый вопрос)

Слот 06.08 21:00 не появился в availability НИ РАЗУ за окно дропа ни на
Court 3, ни на Court 2 — при том, что 20:00 в свой час появился и был взят
нами, а 22:00/23:00 появились в свои. Утром 31.07 слот 21:00 на 06.08
отсутствует на всех 4 падел-кортах. При этом публично 21:00-слоты существуют
(31.07 21:00 свободен на Court 4). Гипотезы:
1. Админ-бронь клуба (регулярка/тренировка четверга 21:00) — слот занят до
   дропа и в availability не выходит вовсе.
2. Слот 21:00 дропается раньше своего часа (например, вместе с 20:00) и был
   разобран до открытия нашего окна 21:58:30.
Разделить гипотезы должен диагностический прогон: в вечер дропа поллить
ПОЛНЫЕ списки слотов всех кортов на T+7 с ~20:50 до ~22:05 и логировать
момент появления КАЖДОГО вечернего слота (19:00–23:00).
