...
//      замена целиком); по нему heartbeat в 23:12 сверяет квитанции. Живые
...
//      По этой отметке heartbeat в 23:12 понимает, что cron сегодня реально
 ...
 * heartbeat в 23:12: без этой записи ему пришлось бы восстанавливать план из
...
export async function runDailyPlanner(deps: PlannerDeps, now: Date): Promise<PlannerRunSummary> {
  ...
  // — и heartbeat в 23:12 скажет об этом вслух. Ошибки по отдельным профилям
