...
/**
 * Правка расписания НЕ отменяет дроп, уже поставленный планировщиком: он
 * почасовой, ран часа H ставится в H:30 со всеми параметрами прямо в payload, и
 * в H:59 тот бронирует, даже если сценарий выключили или удалили в H:45 (ран
 * перечитывает только скипы). Следующие часы правка уже затрагивает — их ставит
 * свой ран. Единственный рычаг на уже поставленный час — «⏭ Скип».
 */
export const RULE_TODAY_HINT =
  'Дроп ближайшего часа, если планировщик его уже поставил (он ставит их в :30), это не отменяет: чтобы не бронировать сегодня, нажми «⏭ Скип» на дату игры.';
